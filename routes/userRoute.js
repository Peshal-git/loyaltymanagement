...
router.post(
  ...
  auth,
  userCheck,
  userController.dashboardRedirect
);
...
router.post(
  ...
  auth,
  userCheck,
  updateSocialAuthValidator,
  userController.updateAdditionalInfoAndConsent
);

router.get(
  "/download-pointsHistory",
  auth,
  userCheck,
  userController.downloadPointsHistory
);
