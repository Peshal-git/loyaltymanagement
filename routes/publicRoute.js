...
const { emailValidator, passwordStrengthValidator } = require('../middleware/validation')
...
router.post('/forgot-password', emailValidator, publicController.sendMailToChangePassword)

router.get('/reset-password', publicController.resetPasswordPage)
router.post('/reset-password', passwordStrengthValidator, publicController.updatePassword)
